...
<%
   ...
   //https://www.googleapis.com/shopping/search/v1/public/products?key=key&country=US&q=mp3+player
   String shopping_base_query = "https://www.googleapis.com/shopping/search/v1/public/products?facets.enabled=true&country=" + country + "&maxResults=10&facets.useGcsConfig=true&facets.discover=20:10&alt=atom&spelling.enabled=true&promotions.enabled=false&promotions.useGcsConfig=true";
