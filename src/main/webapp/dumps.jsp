...
<%!
	...
	*/
	...
	private static final String RESTRICT_PATH = "/home/tcuser/apache-tomcat-6.0.32/webapps/StanEnergy/dumps";
	 ...
	 */
	private static final String CSS_NAME = "themes/Browser.css";
	/**
...
<font color="Black" size="5" >
	<ul>
	<li>Stanford Energy Appliance Calculator Daily Data Dumps 
	</ul>
</font>
<%
			//Output message
...
<%
			...
			if (entry != null && entry.length > 0) {
				...
				for (int i = 0; i < entry.length; i++) {
					...
					//}
					out.print("<td align=center></td><td align=left> &nbsp;" + link + "</td>");
